...
//        /*获取当前是否毕业的状态*/
//// 获取当前是否毕业的状态
//        Integer graduate = userInfoDao.getGraduate(userId);
//        if (graduate!= null) {
//            map.put("graduate_status", graduate);
//        } else {
//            // 这里可以根据需求添加一个默认值，比如 0 表示未毕业
//            map.put("graduate_status", 0);
//        }
//        return map;
//    }
    ...
    public Map getUserInfoById(Map map) {
        ...
        map.put("lastPostTime", postTime);
        // 获取当前是否毕业的状态
        String graduate = userInfoDao.getGraduate(userId);
        map.put("graduate_status_index", graduate);
        // 获取用户的职业信息
        String profession = userInfoDao.getProfession(userId);
        map.put("profession_index", profession);
        return map;
    }
