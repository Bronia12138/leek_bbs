...
public class UserManageController {
    ...
    @RequestMapping("/updateGraduateStatus")
    @Log(operation = "更新毕业状态")
    @ResponseBody
    public ApiResult updateGraduateStatus(@RequestParam("graduateStatus") Integer graduateStatus,
                                          @RequestParam("userId") Integer userId) {
        userManageService.updateGraduateStatus(graduateStatus, userId);
        return ApiResult.of(ResultCode.SUCCESS);
    }
